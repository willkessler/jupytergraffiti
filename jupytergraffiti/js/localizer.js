      ...
      switch (locale) {
        case 'EN':
          localizer.translations['EN'] = {
            ...
            'RECORDING_HINT_1' :                 'Cmd-m ends recording.',
            'RECORDING_HINT_2' :                 'Cmd-m ends recording.',
            ...
            'INSERT_TERMINAL_SUITE':             'Insert Terminal Suite Above',
            'INSERT_TERMINAL_SUITE_ALT_TAG':     'Insert a terminal suite above the currently active cell',
            'INSERT_TERMINAL_SUITE_STATUS':      'Inserting a terminal suite, please wait...',
            'INSERT_GRAFFITI_BUTTON':            'Insert Graffiti Button Above',
            'INSERT_GRAFFITI_BUTTON_ALT_TAG':    'Insert a Graffiti-enabled button in a markdown cell above the currently active cell',
