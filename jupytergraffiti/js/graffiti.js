  ...
  const Graffiti = (function() {
    const graffiti = {
      ...
      toggleAccessLevel: (forcedLevel) => {
        ...
        $('#graffiti-setup-button div').text(buttonLabel);
      },
      ...
      updateSetupButton: () => {
        ...
        const setupButtonDiv = $(buttonContents + '<div>' + buttonLabel + '</div></button></div>');
