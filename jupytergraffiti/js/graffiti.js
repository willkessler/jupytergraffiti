    ...
    const graffiti = {
      ...
      createGraffitiInstantShowHideButton: () => {
        ...
        const opts = {
          ...
          tooltipDirectives: [
            '%%comment "implicit" refers to an autogenerated file this button will include based on the cell you provided. You can provide any file path you want, though.',
